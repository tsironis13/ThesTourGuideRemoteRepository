...
import com.tsiro.fragmentClasses.ExhibitionFragment;
import com.tsiro.fragmentClasses.GoogleMapFragment;
import com.tsiro.fragmentClasses.InfoFragment;
import com.tsiro.fragmentClasses.KatalogFragment;
import com.tsiro.fragmentClasses.NoInternetConnectionFragment;
import com.tsiro.fragmentClasses.PhotoGridViewFragment;
...
public class PlacesDetailsTabs extends ActionBarActivity implements OnGoogleMapFragmentListener, SearchView.OnQueryTextListener, SearchView.OnCloseListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
       ...
       if (!menu.equals("null") && !(menu.length() == 3) && (menu.length() != 10)){ 
       		if (language.equals("Greek")){
