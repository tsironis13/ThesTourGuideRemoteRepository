	...
	public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (button_pressed.equals("Byzantine") || button_pressed.equals("Basiliki") || button_pressed.equals("PaleoChristian") || button_pressed.equals("Macedonian")){
        	if (language.equals("English")){
        		...
        		infosourcetv.setText("Πηγή: http://www.it.uom.gr");
        	}
        }
        	...
        	if (language.equals("English")){
        		...
        		infosourcetv.setText("Πηγή: http://www.thessalonikicityguide.gr");
        	}
        }
        	...
        	if (language.equals("English")){
        		...
        		infosourcetv.setText("Πηγή: http://www.taxidologio.gr");
        	}
        }
        	...
        	if (language.equals("English")){
        		...
        		infosourcetv.setText("Πηγή: www.biscotto.gr");
        	}
        }
        	...
        	if (language.equals("English")){
        		if (place_nameEl.equals("Art House")){
         		   infosourcetv.setText("Πηγή: www.in2life.gr");
         		}else{
         		   infosourcetv.setText("Πηγή: www.biscotto.gr");
         		}
        		
        		if (place_nameEl.equals("Habanita Latin Club")){
          		   infosourcetv.setText("Πηγή: www.monopoli.gr");
          		}else{
          		   infosourcetv.setText("Πηγή: www.biscotto.gr");
          		} 
        	}
